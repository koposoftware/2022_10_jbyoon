...
$(document).ready(function(){
	...
	$('#openCancelBtn').click(function(){
		alert('오픈뱅킹 동의를 취소하고 돌아갑니다.');
...
<body>
	...
	<div class="main-container" style="display: flex; padding-right: 300px;">
		<!-- <div class="pd-ltr-20 xs-pd-20-10">
			
		</div> -->
		<div class="min-height-200px" style="padding: 30px; margin: auto;">
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30"
					...
					<br>
					<button id="btn1_toggle" type="button" class="btn btn-info" style="font-size: larger; font-weight: bold;">약관
						확인</button>
...
본 약관은 2021 년 7 월 30 일부터 개정 시행합니다.
					...
					<br>
					<button id="btn2_toggle" type="button" class="btn btn-info" style="font-size: larger; font-weight: bold;">약관
						확인</button>
...
회 약관」을 적용하기로 하며, 확대시행일은 오픈뱅킹중계센터 홈페이지를 통해 공지합니다.
					...
					<br>
					<button id="btn3_toggle" type="button" class="btn btn-info" style="font-size: larger; font-weight: bold;">약관
						확인</button>
...
이체 약관을 적용하기로 하며, 확대시행일은 오픈뱅킹중계센터 홈페이지를 통해 공지합니다.
					...
					<div style="display: flex; justify-content: center;">
						<c:if test="${access_token eq null}">
							<form id="authorizeFrm" name="authorizeFrm" method="get" action="https://testapi.openbanking.or.kr/oauth/2.0/authorize">
							    ...
							    <!-- 토큰 발급 진행 -->
							    <button id="openCancelBtn" type="button" class="btn btn-info" 
							    		style="padding-left: 25px; padding-right: 25px; font-size: larger; font-weight: bold;">취소</button>
						    	&nbsp&nbsp&nbsp
						    	<button type="submit" id="openChkBtn" type="button" class="btn btn-info" 
						    			style="padding-left: 25px; padding-right: 25px; font-size: larger; font-weight: bold;">확인</button>
							</form>
						</c:if>
					</div>
					...
					<%-- <form id="acount" method="get" action="/account/list">
					    ...
					    <button type="submit" type="button" 
					    		class="btn btn-info" style="margin: 0 auto;">계좌조회</button>
					</form> --%>
